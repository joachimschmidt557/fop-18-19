...
(define (image-similarity img1 img2 max-difference) (* 100 (/
(foldl (lambda (i1 i2 result) (if(<= (+ (abs(- (color-red i1) (color-red i2))) (abs(- (color-green i1) (color-green i2))) (abs(- (color-blue i1) (color-blue i2)))) max-difference) (+ result 1) result)) 0 (image->color-list img1) (image->color-list img2))
